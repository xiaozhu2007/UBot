...
module.exports = function (bot) {
    ...
    bot.on("login", () => {
        ...
        bot.init_readline()
        bot.log("[bot-readline.init] ReadLine 初始化成功")
    })
    ...
    bot.on("end", () => {
        ...
        if (bot.hasInterrupt) {
            ...
            bot.close_readline()
            bot.log("[bot-readline.close] ReadLine 关闭成功")
            process.exit(0)
        } else {
            bot.close_readline()
    ...
    this.safechat = (text) => {
        ...
        this.bot.chat(text)
        this.bot.log("<" + this.bot.username + ">: " + text)
    }
